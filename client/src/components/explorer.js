...
import fetchNFTs from '../utils/nftFetch';
...
const Explore = () => {
    ...
    const fetch = () => {
        fetchNFTs(owner, contractAddress, setNFTs, 0);
    }
            ...
            <header className=' py-24  mb-12 w-full alchemy'>
                ...
                <div className='flex flex-col items-center mb-12'>
                    ...
                    <div className='w-2/6 flex justify-center items-center'>
                        <button className='py-3 bg-white rounded-sm w-full hover:bg-slate-100' onClick={fetch}>Search</button>
                    </div>
                </div>
            </header>
            ...
            <section className='flex flex-wrap justify-center'>
                {
                    NFTs ? NFTs.map((NFT, i) => {
                        ...
                        return (
                            <NftCard key={i} image={NFT.media[0].gateway} id={NFT.id.tokenId} title={NFT.title} address={NFT.contract.address} description={NFT.description} attributes={NFT.metadata.attributes} ></NftCard>
                        )
